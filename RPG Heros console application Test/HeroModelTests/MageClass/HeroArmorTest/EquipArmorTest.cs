...
namespace RPG_Heros_console_application_Test.HeroModelTests.MageClass.HeroArmorTest
{
    public class EquipArmorTest
    {
        ...
        {
            //Arrange
            ArmorModel equipment = new ArmorModel("Common Cloth", SlotEnum.Body, 2, ArmorTypesEnum.Cloth, new Attributes(1, 0, 0));
            // Act & Assert
            Assert.Throws<InvalidArmorException>(() => hero.EquipArmor(equipment));
        }
        [Fact]
        ...
        {
            //Arrange
            ArmorModel equipmentl = new ArmorModel("Common Cloth", SlotEnum.Body, 1, ArmorTypesEnum.Cloth, new Attributes(1, 0, 0));
