...
namespace RPG_Heros_console_application_Test.HeroModelTests.RogueClass.HeroArmorTest
{
    public class TotalAttributesTest
    {
        ...
        {
            //Arrange
            Attributes e = new Attributes(2, 6, 1);        
        ...
        {
            //Arrange
            Attributes e = new Attributes(3, 6, 1);
            int[] expected = { e.Strength, e.Dexterity, e.Intelligence };
        ...
        {
            //Arrange
            Attributes e = new Attributes(4, 6, 1);
            int[] expected = { e.Strength, e.Dexterity, e.Intelligence };
            ArmorModel equipment = new ArmorModel("Common Mail Chest", SlotEnum.Body, 1, ArmorTypesEnum.Mail, new Attributes(1, 0, 0));
        ...
        {
            //Arrange
            Attributes e1 = new Attributes(3, 6, 1);
            int[] Armor1 = { e1.Strength, e1.Dexterity, e1.Intelligence };
            Attributes e2 = new Attributes(4, 6, 1);
