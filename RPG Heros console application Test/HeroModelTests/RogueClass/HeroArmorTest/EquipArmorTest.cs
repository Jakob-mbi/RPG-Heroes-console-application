...
namespace RPG_Heros_console_application_Test.HeroModelTests.RogueClass.HeroArmorTest
{
    public class EquipArmorTest
    {
        ...
        {
            //Arrange
            ArmorModel equipment = new ArmorModel("Common Mail chest", SlotEnum.Body, 2, ArmorTypesEnum.Mail, new Attributes(1, 0, 0));
            // Act & Assert
            Assert.Throws<InvalidArmorException>(() => hero.EquipArmor(equipment));
        }
        [Fact]
        ...
        {
            //Arrange
            ArmorModel equipmentl = new ArmorModel("Common Mail chest", SlotEnum.Body, 1, ArmorTypesEnum.Mail, new Attributes(1, 0, 0));
